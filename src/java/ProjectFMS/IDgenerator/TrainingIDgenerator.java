    ...
    public String generateTrainingId(TrainerBean trainerBean) {
        ...
        try {
            ...
            try {
                ...
                resultSet = statement.executeQuery("Select Training_Seq.nextval from dual");
            } catch (Exception e) {
                statement.execute("create sequence Training_Seq start with 1 increment by 1 nocycle nocache");
                resultSet = statement.executeQuery("Select Training_Seq.nextval from dual");
            }
            if (resultSet.next()) {
