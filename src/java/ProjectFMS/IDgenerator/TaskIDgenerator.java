    ...
    public Serializable generate(SessionImplementor si, Object o) throws HibernateException {
        ...
        try {
            ...
            try {
                ...
                resultSet = statement.executeQuery("Select Task_Seq.nextval from dual");
            } catch (Exception e) {
                statement.execute("create sequence Task_Seq start with 1 increment by 1 nocycle nocache");
                resultSet = statement.executeQuery("Select Task_Seq.nextval from dual");
            }
            if (resultSet.next()) {
